...
%----------------------------------------------------------------------------------
\section{Service}
\cvitem{}{Reviewer for: \emph{IEEE TNNLS}, \emph{Neural Networks}, \emph{Physica D}, \emph{Physical Review E}, \emph{Chaos}, \emph{SIAM J. Applied Mathematics}, \emph{Journal of Computational Physics}, among others.}
